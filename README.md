...
## Clean gamemode scaffold - version 1.3 - (THE MEDICAL NOSE UPDATE)
This package now includes a fresh gamemode scaffold under `framework/sources/gamemode/` with first rebuilt features for visual HUD toggling and bot commands & reworked stim.
